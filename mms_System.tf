...
variable "tag" {
  ...
  description = "Tag to apply to the resources for categorization."
}

variable "functions_version" {
  default     = "4"
  description = "Version of the Azure Functions runtime to use."
}

variable "python_version" {
  default     = "3.9"
  description = "Python runtime version for the Function App. Allowed values: 3.7, 3.8, and 3.9."
}
