...
data "terraform_remote_state" "existing_rg" {
  backend = "azurerm"
...
resource "azurerm_resource_group" "myterraformgroup" {
  count    = data.terraform_remote_state.existing_rg.outputs.resource_group_exists ? 0 : 1
  name     = data.terraform_remote_state.existing_rg.outputs.resource_group_name != "" ? data.terraform_remote_state.existing_rg.outputs.resource_group_name : "${var.app_code}-${var.environment}_rg"
